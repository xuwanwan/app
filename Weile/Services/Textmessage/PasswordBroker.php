...
class PasswordBroker {
	...
	public function remind(array $credentials, Closure $callback = null)
	{
		...
		$this->sendReminder($token, $user->phone);
	 ...
	 * @return int
	 */
	public function sendReminder($token, $to)
	{
		...
		return $this->mailer->send($view, compact('token'), $to);
	}
	...
	public function reset(array $credentials, Closure $callback)
	{
		...
		$this->reminders->delete($credentials['phone']);
